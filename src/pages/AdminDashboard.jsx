      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl p-8 border border-purple-100/50">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <span className="font-bold text-purple-700">اسم المستخدم:</span>
            ...
            <div className="flex gap-2">
              ...
              <span className="text-gray-700">
                {user.role === 1 ? "مشرف" : user.role === 2 ? "محفظ" : "طالب"}
              </span>
            </div>

            <div className="flex gap-2">
              <span className="font-bold text-purple-700">البريد:</span>
              <span className="text-gray-700">{user.email || "غير متوفر"}</span>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
            ...
            <p className="text-green-700 text-sm mt-1">
              هذه صفحة محمية - فقط Admin (role=1) يمكنه رؤيتها
            </p>
          </div>
        </div>
      </div>
